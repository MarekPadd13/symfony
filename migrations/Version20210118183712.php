 ...
 */
final class Version20210118183712 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE profile (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, last_name VARCHAR(180) NOT NULL COLLATE BINARY, first_name VARCHAR(180) NOT NULL COLLATE BINARY, phone VARCHAR(15) NOT NULL COLLATE BINARY, sex INTEGER NOT NULL, patronymic VARCHAR(180) DEFAULT NULL, CONSTRAINT FK_8157AA0FA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE profile');
        $this->addSql('CREATE TABLE profile (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, last_name VARCHAR(180) NOT NULL, first_name VARCHAR(180) NOT NULL, phone VARCHAR(15) NOT NULL, sex INTEGER NOT NULL, patronymic VARCHAR(180) DEFAULT \'Нет данных\' COLLATE BINARY)');
